...
public class ExcelUtil<T>
{
    ...
    public AjaxResult exportExcel()
    {
        ...
        try
        {
        	...
        	Date date = new Date();
        	String filename = formatter.format(date)+"_"+sheetName+".xlsx";
     ...
     */
	/*
	 * public String encodingFilename(String filename) { filename =
	 * UUID.randomUUID().toString() + "_" + filename + ".xlsx"; return filename; }
	 */
