...
$(function() {
     ...
     * 标记父子表中被选中的父表tr
     * */
    $("#agentdataTable tbody").on('click',function(){
    	var plusiconObject = $("#agentdataTable").find("tr").find("td").find(".glyphicon-plus");
    	var minusiconObject = $("#agentdataTable").find("tr").find("td").find(".glyphicon-minus");
...
function InitBagNumberTable (mainNoIndex, fatRow, $fatDetail) {
	...
	var cur_table = $fatDetail.append('<div id="bagDiv'+mainNoIndex+'" style="width:'+agentdataTableDivWid+'"><table id="bagTable'+mainNoIndex+'"></table></div>').find('table');
