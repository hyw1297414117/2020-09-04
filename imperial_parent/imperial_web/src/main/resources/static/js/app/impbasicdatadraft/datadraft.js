...
function InitBagNumberTable (mainNoIndex, fatRow, $fatDetail) {
	...
	dataMap.orderIsdraftFlag = 1;
	var cur_table = $fatDetail.append('<div id="bagDiv'+mainNoIndex+'" style="width:'+impbasicDraftDivWid+'"><table id="bagTable'+mainNoIndex+'"></table></div>').find('table');
...
function queryParams(params) {
    var impParams = {
    	...
    	orderIsdraftFlag:params.orderIsdraftFlag,
